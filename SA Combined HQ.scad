...
module sa_r1_slice () { intersection() { sa_r1(gres); translate([-33,1,0]) cube([66,1,66]); }}
module sa_r1_right_end() { difference() { sa_r1(gres); translate([-33,0,0]) cube(66); }}
module sa_r1_left_end() { difference() { sa_r1(gres); translate([-33,-66,0]) cube(66); }}
...
module sa_r2_slice () { intersection() { sa_r2(gres); translate([-33,1,0]) cube([66,1,66]); }}
module sa_r2_right_end() { difference() { sa_r2(gres); translate([-33,0,0]) cube(66); }}
module sa_r2_left_end() { difference() { sa_r2(gres); translate([-33,-66,0]) cube(66); }}
...
module sa_r3_slice () { intersection() { sa_r3(gres); translate([-33,1,0]) cube([66,1,66]); }}
module sa_r3_right_end() { difference() { sa_r3(gres); translate([-33,0,0]) cube(66); }}
module sa_r3_left_end() { difference() { sa_r3(gres); translate([-33,-66,0]) cube(66); }}
...
module sa_r4_slice () { intersection() { sa_r4(gres); translate([-33,1,0]) cube([66,1,66]); }}
module sa_r4_right_end() { difference() { sa_r4(gres); translate([-33,0,0]) cube(66); }}
module sa_r4_left_end() { difference() { sa_r4(gres); translate([-33,-66,0]) cube(66); }}
...
module sa_r3_bump_slice () {intersection() {sa_r3_bump(gres); translate([-33,1,0]) cube([66,1,66]);}}
module sa_r3_bump_right_end() {difference() {sa_r3_bump(gres); translate([-33,0,0]) cube(66);}}
module sa_r3_bump_left_end() {difference() {sa_r3_bump(gres); translate([-33,-66,0]) cube(66);}}
